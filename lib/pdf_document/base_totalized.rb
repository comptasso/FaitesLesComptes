...
module PdfDocument
  ...
  # la classe BaseTotalized permet d'éditer un fichier pdf reprenant une liste d'information
  # avec des colonnes numériques qui sont totalisées.
  #
  # Et avec un report des totaux et un total final.
  # 
  # La classe descend de Base, qui est capable de faire un pdf tabulaire 
  # à partir d'une collection mais sans totaux
  # 
  ...
  #
  class BaseTotalized < PdfDocument::Base
