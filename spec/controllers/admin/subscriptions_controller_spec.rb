...
describe Admin::SubscriptionsController do
  ...
  describe 'POST create' do
    ...
    it 'crée un nouvel abonnement' do
      @a.should_receive(:new).with(valid_attributes).and_return(@sub = mock_model(Subscription).as_new_record)
    ...
    it 'le sauve' do
      @a.stub(:new).and_return(@sub = mock_model(Subscription))
    ...
    context 'la sauvegarde est valide' do
      ...
      @a.stub(:new).and_return(@sub = mock_model(Subscription, save:true))
        post :create, {organism_id:@o.to_param, subscription:valid_attributes}, valid_session
        response.should redirect_to admin_organism_subscriptions_url(@o)
      end

      it 'avec un flash' do
      @a.stub(:new).and_return(@sub = mock_model(Subscription, title:'nouvel abonnement', save:true))
        post :create, {organism_id:@o.to_param, subscription:valid_attributes}, valid_session
    ...
    context 'la sauvegarde est invalide' do
      ...
      @a.stub(:new).and_return(@sub = mock_model(Subscription, save:false))
        post :create, {organism_id:@o.to_param, subscription:valid_attributes}, valid_session
        response.should render_template('new')
      end
