  ...
  describe 'POST create' do
    ...
    context 'tout va bien' do
      ...
      it 'redirige vers la liste des fichiers'  do
        ...
        post :create, {:file_upload=>@file, database_name:'test2'}
    ...
    describe 'gestion des anomalies et erreurs'  do 
      ...
      it 'vérifie que l adapter est sqlite3' do
        ...
        post :create, {:file_upload=>@file, database_name:'test'}
      ...
      it 'vérifie le format de fichier'   do
        ...
        post :create, {:file_upload=>fixture_file_upload('spec/fixtures/files/test.biz', 'application/octet-stream'), database_name:'test'}
      ...
      it 'vérifie le format de database'  do
        ...
        post :create, {:file_upload=>@file, database_name:'2test2'}
